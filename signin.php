  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		...
		{
          echo '<a class="nav-item btn btn-primary tombol" href="signup.php">create an account</a>.';
		}
				?>
		</a>
          </div>
...
<input id="submit-btn" type="submit" name=submit value="Login" /><a href="#" id="login">
	</form>
	<br>
  <a href="signup.php"><h6>Don't have account yet?</h6></a>
 <?php
  include 'koneksi.php';
